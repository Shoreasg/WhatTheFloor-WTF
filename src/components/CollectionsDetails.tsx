...
const CollectionsDetails = ({ CollectionsDetails }: any) => {
    ...
    return (
        <div className="flex justify-center h-auto w-auto">
            <div className=" rounded-lg bg-white shadow w-auto">
                        ...
                        <div className="sm:flex sm:space-x-5">
                            <div className="flex-shrink-0">
                                ...
                                <div className="mt-4 text-center sm:pt-1">
                                    ...
                                    <p className="text-xs font-bold text-gray-900 sm:text-xs mb-3">{CollectionsDetails?.tokenAddress}</p>
                            ...
                            <div>
                                ...
                                <dl className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
                                    {stats.map((item) => (
                                        <div key={item.name} className="overflow-auto rounded-lg bg-white px-4 py-5 shadow sm:p-6">
